...
class Command(BaseCommand):
    ...
    def handle(self, *args, **opts):
        ...
        from apps.saas.models import Module, CompanyModule
        ...
        CompanyModule.objects.get_or_create(company=acme, module=fin_module, defaults={"is_active": True})
        CompanyModule.objects.get_or_create(company=acme, module=hr_module, defaults={"is_active": True})
        ...
        # Seed dynamic roles/permissions inside tenant schema for acme
        admin_user = User.objects.get(email="admin@acme.test")
        from apps.saas.signup_views import SignupView
        SignupView._seed_tenant_roles("acme", [ProductCode.FIN, ProductCode.HR], admin_user)
