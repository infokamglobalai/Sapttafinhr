...
from .views import (
    ...
    DayBookView, DirectTaxView, PartyLedgerView, PnLView, ReceivablesRiskView,
    SalesRegisterView, VATReturnView,
)
...
urlpatterns = [
    ...
    path("direct-tax/", DirectTaxView.as_view(), name="direct-tax"),
]
