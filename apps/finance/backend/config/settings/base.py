...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": (
        ...
        "apps.core.permissions.HasWorkspacePermission",
    ),
...
WHATSAPP_PROVIDER = env("WHATSAPP_PROVIDER", default="meta")
META_WHATSAPP_TOKEN = env("META_WHATSAPP_TOKEN", default="")
META_WHATSAPP_PHONE_ID = env("META_WHATSAPP_PHONE_ID", default="")

# ===== Taxation (E-Invoice & E-Way Bill) =====
EINVOICE_CLIENT_ID = env("EINVOICE_CLIENT_ID", default="")
EINVOICE_CLIENT_SECRET = env("EINVOICE_CLIENT_SECRET", default="")
EINVOICE_USERNAME = env("EINVOICE_USERNAME", default="")
EINVOICE_PASSWORD = env("EINVOICE_PASSWORD", default="")
EINVOICE_BASE_URL = env("EINVOICE_BASE_URL", default="https://einv-apisandbox.nic.in")

EWB_CLIENT_ID = env("EWB_CLIENT_ID", default="")
EWB_CLIENT_SECRET = env("EWB_CLIENT_SECRET", default="")
EWB_USERNAME = env("EWB_USERNAME", default="")
EWB_PASSWORD = env("EWB_PASSWORD", default="")
EWB_BASE_URL = env("EWB_BASE_URL", default="https://ewb-apisandbox.nic.in")
