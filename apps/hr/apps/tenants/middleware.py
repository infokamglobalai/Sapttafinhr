...
class TenantMiddleware:
    ...
    def _resolve_tenant(self, request):
        ...
        # Single-domain fallback / Dev / superadmin: fall back to the authenticated user's tenant.
        # This allows accessing the HR app under the base domain (no subdomains) or local dev hosts.
        if host == superadmin_domain or host == tenant_base_domain or host in ("localhost", "127.0.0.1"):
