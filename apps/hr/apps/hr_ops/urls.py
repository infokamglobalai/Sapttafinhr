...
urlpatterns = [
    ...
    path("exits/<int:pk>/acknowledge-hr/", views.exit_acknowledge_hr, name="exit_acknowledge_hr"),
    path("exits/<int:pk>/acknowledge-employee/", views.exit_acknowledge_employee, name="exit_acknowledge_employee"),
