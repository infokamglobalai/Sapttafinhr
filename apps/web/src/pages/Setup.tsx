...
export default function Setup() {
  ...
  return (
    <div className="setup-page">
      {/* Desktop sidebar */}
      <aside className="setup-page__sidebar">
      ...
      {/* Mobile step bar */}
      <div className="setup-page__mobile-header">
        <SapttaLogo />
        <Steps
          current={currentStep}
          size="small"
        ...
        />
        <div className="setup-page__mobile-meta">
          <div className="setup-page__mobile-tags">
            {products.map(p => (
              <Tag key={p} color={p === 'hrms' ? 'orange' : 'green'} style={{ fontSize: 11, fontWeight: 600, borderRadius: 8 }}>
                {p.toUpperCase()}
              </Tag>
          ...
          <div>
            ...
            <Form form={hrmsForm} layout="vertical" requiredMark={false}>
              ...
              <div style={{ marginBottom: 32 }}>
                ...
                <div className="setup-page__grid-2">
                  {leaveTypes.map(lt => (
          ...
          <div>
            ...
            <Form form={financeForm} layout="vertical" requiredMark={false} initialValues={{ fiscalYearStart: '2025-04-01' }}>
              ...
              <div style={{ marginBottom: 32 }}>
                ...
                <div className="setup-page__row setup-page__row--fiscal">
...
function ReviewCard({ title, items }: { title: string; items: { label: string; value: string }[] }) {
  return (
    <div style={{ background: '#FFFFFF', borderRadius: 16, padding: '24px', border: '1px solid var(--color-border)' }}>
      ...
      <div className="setup-page__review-grid">
        {items.map(item => (
          <div key={item.label}>
