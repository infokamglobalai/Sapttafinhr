...
const industries: IndustryData[] = [
  {
    ...
    title: 'IT & Technology',
    accent: '#1E2A78',
    gradient: 'linear-gradient(135deg, rgba(30,42,120,0.14) 0%, rgba(255,109,0,0.08) 55%, #FFFFFF 100%)',
    icon: '💻',
  ...
  },
  {
    ...
    title: 'Retail & FMCG',
    accent: '#FF6D00',
    gradient: 'linear-gradient(135deg, rgba(255,109,0,0.16) 0%, rgba(255,152,0,0.10) 45%, #FFFFFF 100%)',
    icon: '🛒',
  ...
  },
  {
    ...
    title: 'Logistics',
    accent: '#FF6D00',
    gradient: 'linear-gradient(135deg, rgba(255,109,0,0.16) 0%, rgba(30,42,120,0.10) 55%, #FFFFFF 100%)',
    icon: '🚚',
